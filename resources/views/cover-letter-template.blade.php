                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex gap-3">
                            ...
                            <a href="{{ route('cover-letter.build', ['template' => 'template-1']) }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition">Download</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex gap-3">
                            ...
                            <a href="{{ route('cover-letter.build', ['template' => 'template-2']) }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition">Download</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex gap-3">
                            ...
                            <a href="{{ route('cover-letter.build', ['template' => 'template-3']) }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition">Download</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-6 flex gap-3">
                            ...
                            <a href="{{ route('cover-letter.build', ['template' => 'template-4']) }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition">Download</a>
                        </div>
                    </div>
                </div>
