...
<head>
    ...
    <title>Cover Letter Preview - Creative</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Courier+Prime&display=swap');
        body { font-family: 'Courier Prime', monospace; background-color: #e5e7eb; }
        .a4-sheet {
            width: 210mm;
            height: 297mm;
            margin: 2rem auto;
    ...
    <div class="a4-sheet p-12">
        @if($coverLetter)
            <div class="text-right mb-12">
                ...
                <p class="mt-4 text-gray-600">{{ \Carbon\Carbon::parse($coverLetter->letter_date)->format('F j, Y') }}</p>
            </div>
            ...
            <div class="mt-12">
                ...
                <p class="mt-8 font-bold text-gray-800">{{ $coverLetter->full_name }}</p>
            </div>
        @else
