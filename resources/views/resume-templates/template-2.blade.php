...
<head>
    ...
    <style>
        body {
            ...
            color: #f5f5f5;
            background-color: #555; /* Neutral dark background */
        }
        .page {
            background: #2c2c2c;
            width: 210mm;
        ...
        .watermark {
            ...
            font-size: 120px;
            color: rgba(255, 255, 255, 0.05); /* Lighter watermark for dark theme */
            font-weight: bold;
            pointer-events: none;
            white-space: nowrap;
            z-index: 1;
        ...
        .header { text-align: center; margin-bottom: 30px; border-bottom: 1px solid #555; padding-bottom: 20px; }
